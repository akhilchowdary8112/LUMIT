...
public class MainActivity15<PhoneAuthOptions> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtPhone = findViewById(R.id.idEdtNumber);
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString()) ){
                    ...
                    Toast.makeText(MainActivity15.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
        ...
        verifyOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtOTP.getText().toString())){
                    ...
                    Toast.makeText(MainActivity15.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                }else{
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i =new Intent(MainActivity15.this,MainActivity3.class);
                            ...
                            Toast.makeText(MainActivity15.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Toast.makeText(MainActivity15.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
